...
const CompanyInformationPage = () => {
    ...
    const onFinish = async (values: Record<string, unknown>) => {
        try {
            ...
            // const imageFile = values.image_company?.[0]?.originFileObj;

            // // Convert sang URL giả sử bạn upload lên server và nhận lại URL
            // const logoUrl = logoFile ? await uploadToServer(logoFile) : null;
            // const imageUrl = imageFile ? await uploadToServer(imageFile) : null;
