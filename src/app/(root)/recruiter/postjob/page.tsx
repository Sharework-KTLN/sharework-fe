...
import { Form, Input, Select, Avatar, DatePicker, message, Spin } from 'antd';
...
const PostJobPage = () => {
    ...
    const onFinish = async (values: Record<string, unknown>) => {
        try {
            ...
            if (response.ok) {
                messageApi.success("Đăng bài tuyển dụng thành công!");
                form.resetFields();  // 🔥 Xóa dữ liệu trong form sau khi đăng thành công
            } else {
                messageApi.error("Lỗi khi đăng bài: " + data.message);
            }
        } catch (error) {
